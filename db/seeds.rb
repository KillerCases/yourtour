...
Tour.delete_all
Tour.create([{name:"Turnpike Murals", short_description: "Turnpike Lane is a busy cosmopolitan neighbourhood in North East London. Its also home to the Turnpike Art Group (TAG) founded in 2012 as a community-focused street redesign programme. Since then, TAG has commissioned numerous works from artists around the world, all with the mission of breaking down gallery walls and changing the urban landscape. This tour will give you a flavour for the neighbourhood and explain the history and ethos of different artworks.", tour_guide_id: "1", tour_city_id: "4", tour_price_id:"2", long_description:"Turnpike Lane", meeting_point_description: "Turnpike Lane Underground Station", min_customer_threshold:"1", address:"Turnpike Lane Underground Station, London, UK"}])
