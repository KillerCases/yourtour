...
Tour.delete_all
Tour.create([{name:"Turnpike Murals", short_description: "Turnpike Lane artist community gives a tour of the murals in the local area", tour_guide_id: "1", tour_city_id: "4", tour_price_id:"2", long_description:"Turnpike Lane", meeting_point_description: "Turnpike Lane Underground Station", min_customer_threshold:"1", address:"Turnpike Lane Underground Station, London, UK"}])
